...
create_clock -period 6.7204 clk_pixel
create_clock -waveform {0.3360 1.0081} -period 1.3441 clk_pixel_10x
create_clock -period 4.0323 clk_200m
...
# set_clock_latency -source -setup <board_max + 0.026> [get_ports {clk_200m}]
# set_clock_latency -source -hold <board_min + 0.054> [get_ports {clk_200m}]
